...
class ItemViewModel(private val itemId: String?, private val itemRepository: ItemRepository) :
    ...
    fun saveItem(title: String, url:String, totalReleases:Int, isOpenSource: Boolean, platform:String, releaseDate: Date, lastVersion:String, imageUrl:String){
        viewModelScope.launch {
            ...
            try{
                ...
                val item = uiState.game.copy(title=title, url=url, totalReleases = totalReleases, isOpenSource = isOpenSource, platform=platform
                    , releaseDate = convertDateToString(releaseDate), lastVersion = lastVersion, imageUrl = imageUrl)
    ...
    fun UpdateItem(title: String, url:String, totalReleases:Int, isOpenSource: Boolean, platform:String,releaseDate: Date, lastVersion:String, imageUrl:String) {
        viewModelScope.launch {
            ...
            try {
                ...
                val item = uiState.game.copy(title=title, url=url, totalReleases = totalReleases, isOpenSource = isOpenSource,
                    platform=platform, releaseDate = convertDateToString(releaseDate), lastVersion = lastVersion, imageUrl = imageUrl)
