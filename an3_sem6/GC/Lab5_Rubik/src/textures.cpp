...
GLuint load_texture32(const char* data, int width, int height, GLuint* texId)
{
	GLuint rezTextura;    
...
GLuint load_texture16(const unsigned short* data, int width, int height, GLuint* texId)
{
